...
urlpatterns = [
    ...
    path("crm/inbox/<uuid:conversation_id>/reply/", staff_views.StaffReplyView.as_view(), name="crm-reply"),
    ...
    path("cms/pages/<uuid:pk>/", staff_views.CMSPageDetailView.as_view(), name="cms-page-detail"),
    path("cms/pages/<uuid:pk>/edit/", staff_views.CMSPageUpdateView.as_view(), name="cms-page-update"),
    path("cms/pages/<uuid:pk>/publish/", staff_views.CMSPagePublishView.as_view(), name="cms-page-publish"),
    path("cms/pages/<uuid:pk>/unpublish/", staff_views.CMSPageUnpublishView.as_view(), name="cms-page-unpublish"),
    path("cms/pages/<uuid:pk>/archive/", staff_views.CMSPageArchiveView.as_view(), name="cms-page-archive"),
    path("cms/pages/<uuid:pk>/delete/", staff_views.CMSPageDeleteView.as_view(), name="cms-page-delete"),
    path("cms/pages/<uuid:pk>/blocks/add/", staff_views.CMSBlockAddView.as_view(), name="cms-block-add"),
    path("cms/pages/<uuid:page_pk>/blocks/<uuid:block_pk>/edit/", staff_views.CMSBlockUpdateView.as_view(), name="cms-block-update"),
    path("cms/pages/<uuid:page_pk>/blocks/<uuid:block_pk>/delete/", staff_views.CMSBlockDeleteView.as_view(), name="cms-block-delete"),
    path("cms/pages/<uuid:pk>/blocks/reorder/", staff_views.CMSBlockReorderView.as_view(), name="cms-block-reorder"),
    path("cms/redirects/", staff_views.CMSRedirectListView.as_view(), name="cms-redirect-list"),
    path("cms/redirects/add/", staff_views.CMSRedirectCreateView.as_view(), name="cms-redirect-create"),
    path("cms/redirects/<uuid:pk>/delete/", staff_views.CMSRedirectDeleteView.as_view(), name="cms-redirect-delete"),
    path("cms/settings/", staff_views.CMSSettingsView.as_view(), name="cms-settings"),
    # Blog Posts (under CMS)
    path("cms/posts/", staff_views.BlogPostListView.as_view(), name="blog-post-list"),
    path("cms/posts/add/", staff_views.BlogPostCreateView.as_view(), name="blog-post-create"),
    path("cms/posts/<uuid:pk>/", staff_views.BlogPostDetailView.as_view(), name="blog-post-detail"),
    path("cms/posts/<uuid:pk>/edit/", staff_views.BlogPostUpdateView.as_view(), name="blog-post-update"),
    path("cms/posts/<uuid:pk>/publish/", staff_views.BlogPostPublishView.as_view(), name="blog-post-publish"),
    path("cms/posts/<uuid:pk>/unpublish/", staff_views.BlogPostUnpublishView.as_view(), name="blog-post-unpublish"),
    path("cms/posts/<uuid:pk>/delete/", staff_views.BlogPostDeleteView.as_view(), name="blog-post-delete"),
    # Blog Categories (under CMS)
    path("cms/categories/", staff_views.BlogCategoryListView.as_view(), name="blog-category-list"),
    path("cms/categories/add/", staff_views.BlogCategoryCreateView.as_view(), name="blog-category-create"),
    path("cms/categories/<uuid:pk>/edit/", staff_views.BlogCategoryUpdateView.as_view(), name="blog-category-edit"),
    path("cms/categories/<uuid:pk>/delete/", staff_views.BlogCategoryDeleteView.as_view(), name="blog-category-delete"),
    # Diver management
